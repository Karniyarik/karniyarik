...
String title = "";
if(type.trim().equals("gear")){
	list = productUtil.getGear(searchResult);
	title = "Vites Tipi Filtrele";
} else if(type.trim().equals(SearchConstants.BRAND)){
	list = productUtil.getBrand(searchResult);
	title = "Marka Filtrele";
} else if(type.trim().equals("color")){
	list = productUtil.getColor(searchResult);
	title = "Renk Filtrele";
} else if(type.trim().equals("city")){
	list = productUtil.getCity(searchResult);
	title = "Şehir Filtrele";
} else if(type.trim().equals("fuel")){
	list = productUtil.getFuel(searchResult);
	title = "Yakıt Tipi Filtrele";
}
...
<%@page import="com.karniyarik.ir.SearchConstants"%><wng:document>
	<wng:head>
