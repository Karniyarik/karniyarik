...
<%SearchResult searchResult = SearchResultRequestWrapper.getInstance(request).getSearchResult();int size = 3;%>
<html>
	<head>
		...
		#urunfirsat {border:2px solid #C18AB1; width: 116px; background:white;}
		#urunfirsat ul{width: 176px !important;}
		#urunfirsat li{background:white;width: 176px;height: 200px;}
		#urunfirsat .ppho {text-align: center;padding:4px;}
		#urunfirsat .ppho img {width: 168px; height:106px; border:1px solid gray;}
		#urunfirsat .pri {margin-left:3px;width: 170px;}
		...
		#urunfirsat .pri .p {font-size:12px;font-weight:bold;line-height:20px;vertical-align: middle;}
		#urunfirsat .pri .p .item1 {float:left;width:170px;}
		div#controls1 {margin:0;position:relative;} 
		#controls1 #prevBtn, #controls1 #nextBtn{display:block;margin:0;overflow:hidden;text-indent:-8000px;width:40px;height:20px;position:absolute;left:68px;}											
		#controls1 #prevBtn{top:-222px;}
		</style>
	</head>
<body>
<div style="width:190px;height:370px;margin-left:auto;margin-right:auto;">
				...
				<li>
					...
					<div class="ppho">
				        <a rel="nofollow" href="<%=url%>" title="Ürün fırsatının sayfasına git">
				        	  ...
				        	  imgBuff.append(".png");
				        	  imgBuff.append("?w=168&h=106&v=");
				        	  imgBuff.append(product.getImageURL());
				        	  String imgUrl = imgBuff.toString();%>
					    	<img src="<%=imgBuff%>" height="106" width="168" alt="Ürün Fırsatı Resmi"/>
					    </a>					
					</div>
				    <div class="pri">
				    	...
				    	<div class="p">
				    		<span class="item1">
				    			<a rel="nofollow" class="purple" href="<%=url%>" title="Ürün fırsatının sayfasına git">
