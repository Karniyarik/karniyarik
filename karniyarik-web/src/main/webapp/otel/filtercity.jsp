...
List<LinkedLabel> list = otelUtil.getCity(searchResult);
String[] values = otelUtil.getFilterData(list, "city", request);
String data = values[0];
String value = values[1];
%>
<div class="feas otel">
  <div class="lhead" title="Sadece belli bir şehirdeki otelleri göster">
  ...
  <%for(LinkedLabel linkedLabel: list){%>
    <div class="pb">
      <label>
	    ...
	    <span><a title="Sadece <%=linkedLabel.getLabel()%> şehirindeki otelleri göster" href="<%=linkedLabel.getLink()%>"><%=linkedLabel.getLabel()%></a></span>
