...
<head>
<title>Upload Brands File</title>
...
<body>
  <div class="container">
    ...
    <div class="span-24 last rndb">
    	...
    	<%} else {%>
    		<span class="error">An error occured, cannot distribute the file to executors</span>
    	<%}%> 
    	</div>
    	<div class="span-23 last cl"></div>
    	<div class="span-23 mt10">
    	<form method="post" enctype="multipart/form-data" action="<%=request.getContextPath()%>/rest/uploadbrand">
