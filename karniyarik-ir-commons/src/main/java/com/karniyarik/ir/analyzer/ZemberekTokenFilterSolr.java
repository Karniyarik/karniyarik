...
public class ZemberekTokenFilterSolr extends TokenFilter {
	...
	public ZemberekTokenFilterSolr(TokenStream input) {
		super(input);
		cozumlenenTokenStack = new Stack<Token>();
		this.zemberek = ZemberekFactorySolr.getInstance().create();
	}
