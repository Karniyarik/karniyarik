...
public class Potfix {
    ...
    public static final String ISIM_SAHIPLIK_ONLAR_I = "ISIM_SAHIPLIK_ONLAR_I";
    public static final String ISIM_BELIRTME_I = "ISIM_BELIRTME_I";
    
    public static Set<String> CEKIM_EKLERI = new HashSet<String>();
    
    static {
    	CEKIM_EKLERI.add(ISIM_COGUL_LER);
    	CEKIM_EKLERI.add(ISIM_SAHIPLIK_BEN_IM);
    	CEKIM_EKLERI.add(ISIM_SAHIPLIK_BIZ_IMIZ);
    	CEKIM_EKLERI.add(ISIM_SAHIPLIK_O_I);
    	CEKIM_EKLERI.add(ISIM_SAHIPLIK_ONLAR_I);
    	CEKIM_EKLERI.add(ISIM_SAHIPLIK_SEN_IN);
    	CEKIM_EKLERI.add(ISIM_SAHIPLIK_SIZ_INIZ);
    	CEKIM_EKLERI.add(ISIM_BELIRTME_I);
    }
    ...
    public static final String ISIM_KISI_ONLAR_ = "ISIM_KISI_ONLAR_";
    ...
    public static final String FIIL_EMIR_ONLAR_SIN = "FIIL_EMIR_ONLAR_SIN";
