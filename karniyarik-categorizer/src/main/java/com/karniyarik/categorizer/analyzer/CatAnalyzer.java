...
import com.karniyarik.ir.analyzer.StrictZemberekFilter;
import com.karniyarik.ir.analyzer.SynonymFilter;
import com.karniyarik.ir.analyzer.WordDelimiterFilter;
import com.karniyarik.ir.analyzer.ZemberekFilter;

public class CatAnalyzer extends Analyzer {
	...
	public CatAnalyzer(Zemberek zemberek, boolean isStrict, boolean isForSearch) {
	...
	public TokenStream tokenStream(String fieldName, Reader reader) {
		...
		if (isForSearch) {
			result =
				new WordDelimiterFilter(
						...
						0, //catenateWords  1, causes maximum runs of word parts to be catenated: "wi-fi" => "wifi"
		...
		result = new CatZemberekFilter(zemberek, result);
